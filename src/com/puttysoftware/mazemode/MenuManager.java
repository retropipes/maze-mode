...
public class MenuManager {
    ...
    private JMenuItem fileNew, fileOpen, fileOpenRecent, fileClose, fileSave, fileSaveAs, filePrint, fileExit;
    ...
    private KeyStroke fileNewAccel, fileOpenAccel, fileOpenRecentAccel, fileCloseAccel, fileSaveAccel, fileSaveAsAccel,
	    filePrintAccel;
	...
	this.fileOpenRecentAccel = KeyStroke.getKeyStroke(KeyEvent.VK_O, modKey | InputEvent.SHIFT_DOWN_MASK);
	...
	this.playPlayMazeAccel = KeyStroke.getKeyStroke(KeyEvent.VK_P, modKey | InputEvent.SHIFT_DOWN_MASK);
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("New...")) {
			...
			final int result = CommonDialogs.showConfirmDialog(
				"Are you sure you want to reset the current level?", MazeMode.getProgramName());
