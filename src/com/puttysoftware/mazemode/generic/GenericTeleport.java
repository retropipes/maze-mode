...
public abstract class GenericTeleport extends MazeObject {
	...
	return MazeMode.getApplication().getGameManager().getPlayerManager().getPlayerLocationW();
    }
	...
	MazeMode.getApplication().showMessage(this.getName() + ": Destination (" + (this.destCol + 1) + ","
