...
public abstract class GenericProgrammableLock extends GenericSingleLock {
	...
	if (this.isConditionallyDirectionallySolid(ie, dirX, dirY, inv)) {
		...
		MazeMode.getApplication().showMessage("You need a " + this.getKey().getName());
	    }
	}
	...
	final MazeObject o = MazeMode.getApplication().getObjects().readMazeObjectX(reader, formatVersion);
	if (o == null) {
