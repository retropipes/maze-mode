...
public class MazeObjectList {
    ...
    public MazeObject readMazeObjectX(final XDataReader reader, final int formatVersion) throws IOException {
	MazeObject o = null;
	String UID = "";
    ...
    public void readRuleSetX(final XDataReader reader, final int rsFormat) throws IOException {
	// Read map length
