...
public abstract class MazeObject
    ...
    public final void writeMazeObjectX(final XDataWriter writer) throws IOException {
    ...
    public final MazeObject readMazeObjectX(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
    ...
    public final MazeObject readMazeObjectX2(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getXIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == MazeObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
    ...
    public final MazeObject readMazeObjectX3(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getXIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == MazeObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
    ...
    public final MazeObject readMazeObjectX4(final XDataReader reader, final String ident, final int ver)
	    throws IOException {
	if (ident.equals(this.getXIdentifier())) {
	    final int cc = this.getCustomFormat();
	    if (cc == MazeObject.CUSTOM_FORMAT_MANUAL_OVERRIDE) {
     ...
     * @throws IOException
     */
    protected void writeMazeObjectHookX(final XDataWriter writer) throws IOException {
     ...
     * @throws IOException
     */
    protected MazeObject readMazeObjectHookX(final XDataReader reader, final int formatVersion) throws IOException {
