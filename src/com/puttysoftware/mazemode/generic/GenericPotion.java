...
public abstract class GenericPotion extends MazeObject {
	...
	MazeMode.getApplication().getGameManager().addToScore(GenericPotion.SCORE_CONSUME);
    }
	...
	MazeMode.getApplication().getGameManager().addToScore(GenericPotion.SCORE_SMASH);
	return false;
    }
