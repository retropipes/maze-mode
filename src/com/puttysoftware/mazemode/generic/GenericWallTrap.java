...
public abstract class GenericWallTrap extends MazeObject {
	...
	MazeMode.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this.masterTrigger);
	if (this.number == GenericWallTrap.NUMBER_MASTER) {
	    MazeMode.getApplication().getMazeManager().getMaze().masterTrapTrigger();
	} else {
	    MazeMode.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this);
	    MazeMode.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this.trigger);
	}
