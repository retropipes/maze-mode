...
public class UTurnTrap extends GenericTrap {
	...
	MazeMode.getApplication().showMessage("Your controls are turned around!");
	MazeMode.getApplication().getGameManager().activateEffect(MazeEffectConstants.EFFECT_U_TURNED,
