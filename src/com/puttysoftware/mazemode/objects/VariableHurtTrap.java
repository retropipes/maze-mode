...
public class VariableHurtTrap extends GenericTrap {
	...
	this.maxDamage = MazeMode.getApplication().getMazeManager().getMaze().getMaximumHP() / 10;
	...
	MazeMode.getApplication().getMazeManager().getMaze().doDamage(this.damageDealt.generate());
