...
public class ShockBomb extends GenericUsableObject {
	...
	MazeMode.getApplication().getMazeManager().getMaze().radialScanShockObjects(x, y, z, ShockBomb.EFFECT_RADIUS);
	// Shock the ground, too
	MazeMode.getApplication().getMazeManager().getMaze().radialScanShockGround(x, y, z, ShockBomb.EFFECT_RADIUS);
    }
