...
public class HalfHourglass extends GenericTimeModifier {
	...
	MazeMode.getApplication().getMazeManager().getMaze().extendTimerByInitialValueHalved();
	SoundManager.playSound(SoundConstants.SOUND_CATEGORY_SOLVING_MAZE, SoundConstants.SOUND_GRAB);
	MazeMode.getApplication().getGameManager().addToScore(HalfHourglass.SCORE_GRAB);
    }
