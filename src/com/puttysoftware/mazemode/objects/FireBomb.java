...
public class FireBomb extends GenericUsableObject {
	...
	MazeMode.getApplication().getMazeManager().getMaze().radialScanEnrageObjects(x, y, z, FireBomb.EFFECT_RADIUS);
	// Burn the ground, too
	MazeMode.getApplication().getMazeManager().getMaze().radialScanBurnGround(x, y, z, FireBomb.EFFECT_RADIUS);
    }
