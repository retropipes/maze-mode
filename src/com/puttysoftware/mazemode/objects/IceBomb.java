...
public class IceBomb extends GenericUsableObject {
	...
	MazeMode.getApplication().getMazeManager().getMaze().radialScanFreezeObjects(x, y, z, IceBomb.EFFECT_RADIUS);
	// Freeze ground, too
	MazeMode.getApplication().getMazeManager().getMaze().radialScanFreezeGround(x, y, z, IceBomb.EFFECT_RADIUS);
    }
