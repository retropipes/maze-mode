...
public class RotationWand extends GenericWand {
	...
	final String rres = CommonDialogs.showInputDialog("Rotation Radius:", MazeMode.getProgramName(), rChoices,
		rChoices[r - 1]);
	try {
	...
	final String dres = CommonDialogs.showInputDialog("Rotation Direction:", MazeMode.getProgramName(), dChoices,
		dChoices[di]);
	...
	if (d) {
	    ...
	    MazeMode.getApplication().getGameManager().doCounterclockwiseRotate(r);
	}
