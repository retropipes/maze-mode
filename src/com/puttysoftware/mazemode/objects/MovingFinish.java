...
public class MovingFinish extends Finish {
	...
	this.active = true;
	this.activateTimer(MazeMode.getApplication().getMazeManager().getMaze().getFinishMoveSpeed());
    }
	...
	this.active = false;
	final MazeObject obj = MazeMode.getApplication().getMazeManager().getMazeObject(this.getDestinationRow(),
