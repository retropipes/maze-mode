...
public class DamagedWall extends GenericWall {
	...
	// Destroy the wall
	final int pz = MazeMode.getApplication().getGameManager().getPlayerManager().getPlayerLocationZ();
	MazeMode.getApplication().getGameManager().morph(new CrumblingWall(), dirX, dirY, pz);
