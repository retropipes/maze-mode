...
public class VariableHealTrap extends GenericTrap {
	...
	this.maxHealing = MazeMode.getApplication().getMazeManager().getMaze().getMaximumHP() / 10;
	...
	MazeMode.getApplication().getMazeManager().getMaze().heal(this.healingGiven.generate());
