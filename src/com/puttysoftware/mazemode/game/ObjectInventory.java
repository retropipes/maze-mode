...
public final class ObjectInventory implements Cloneable {
    ...
    public static ObjectInventory readInventoryX(final XDataReader reader, final int formatVersion) throws IOException {
	...
	i.amulet = (GenericAmulet) objects.readMazeObjectX(reader, formatVersion);
	if (i.amulet == null) {
