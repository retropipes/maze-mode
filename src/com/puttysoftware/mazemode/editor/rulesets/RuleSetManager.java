...
public class RuleSetManager {
	...
	final FileDialog fc = new FileDialog(app.getOutputFrame(), "Load Rule Set", FileDialog.LOAD);
	fc.setVisible(true);
	...
	String fileOnly = "\\";
	String extension;
	final FileDialog fc = new FileDialog(app.getOutputFrame(), "Save Rule Set", FileDialog.SAVE);
